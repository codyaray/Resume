...
\includecomment{software}  % Software Engineering
...
\includecomment{tech}        % Technology or Engineering (Category)
\excludecomment{educate} % Educational Innovator
\excludecomment{general}  % General Resume for connectors, executives, etc.
