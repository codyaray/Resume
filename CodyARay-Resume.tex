...
% \begin{itemize} \itemsep -2pt  % reduce space between items
% \item Produced multi-agent system security issues and countermeasures white-paper
% \item Prototyped transparent multicast communications security for Linux kernel in C
...
\section{Engineering \\ Skills}
   \begin{tabular}{l p{3in}}
    ...
    \underline{Datastores:} & Kafka, Cassandra, Elasticsearch, KairosDB, Mongo, %MS SQL,
    MySQL, 
    PostgreSQL,
    Redis \\
