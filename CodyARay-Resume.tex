...
\excludecomment{software}  % Software Engineering
\excludecomment{controls}  % Controls or Robotics Engineering
\excludecomment{telecom}  % Telecommunications and Digital Signal Processing
\excludecomment{tech}        % Technology or Engineering (Category)
\excludecomment{educate} % Educational Innovator
\includecomment{general}  % General Resume for connectors, executives, etc.
...
% Objective section for all except general
\begin{software}
\section{Objective}
\end{software}
\begin{controls}
...
\end{software}
% KEEP ^ v IN SYNC. Want to show on _both_ software and general
\begin{general}
     \underline{Libraries:} & Ant, CodeIgniter, Cucumber, jUnit, Rails, RSpec \\
\end{general}
...
\end{telecom}
% KEEP ^ v IN SYNC. Want to show on _all_ telecom and controls and general
\begin{controls}
     \underline{Research:} & Arduino, Function Generator, Pencilbox Logic \\ & Designer, Roomba, Spartan3 FPGA, TIMS
\end{controls}
% KEEP ^ v IN SYNC. Want to show on _all_ telecom and controls and general
...
\vspace{-3mm} \section{Service and Outreach}
	...
	\end{list}
\end{educate}
% KEEP ^ v (mostly) IN SYNC. Want to show on _all_ telecom and controls and general
\begin{general}
\vspace{-3mm} \section{Service and Outreach}
	\begin{list}{\labelitemi}{\leftmargin=1em} \itemsep -2pt %reduce space between items
	\item Member, College of Engineering Dean Search Committee, 2010--Present
...
\end{educate}
% KEEP ^ v IN SYNC. Want to show on _both_ educate and general
\begin{general}
\section{Certifications}
Leadership in Energy and Environmental Design Accredited Professional (LEED AP)
\end{general}
...
\end{list}
\end{educate}
% KEEP ^ v (mostly) IN SYNC. Want to show on _both_ educate and general
\begin{general}
...
\end{tech}
% KEEP ^ v IN SYNC. Want to show on _both_ tech and general
\begin{general}
\section{Selected \\ Technical \\ Projects}
\end{general}
...
\end{itemize}
\end{software}
% KEEP ^ v IN SYNC. Want to show on _both_ software and controls
\begin{controls}
{\bf Command-Line Kalah,} CS 510 Artificial Intelligence \hfill  Fall 2010 \\
Play Kalah against the computer or pit different AI algorithms against one another
\begin{itemize} \itemsep -2pt %reduce space between items
...
Recognize objects using Fourier descriptors and minimum-distance classification
 ...
 \end{itemize}
\end{telecom}
% KEEP ^ v (mostly) IN SYNC. Want to show on _both_ tech and general
\begin{general}
